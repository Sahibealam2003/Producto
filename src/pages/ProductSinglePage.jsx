...
const ProductSinglePage = () => {
  ...
  if (!findData)
    return <p className="p-6 text-orange-600">Product Not Found</p>;
    ...
    <>
      ...
      <div className="w-[85%] mx-auto font-sans my-10">
        ...
        <div className="mt-6 text-center">
          ...
          <button className="bg-orange-600 text-white font-semibold px-6 py-2 rounded shadow-md hover:bg-orange-700 transition duration-300">
